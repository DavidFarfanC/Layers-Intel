...
export default function Hero() {
  return (
    <section className="relative min-h-screen overflow-hidden bg-gradient-to-br from-slate-50 via-white to-blue-50/40 pt-24 pb-16">
      {/* Decorative blobs */}
      <div className="pointer-events-none absolute -top-40 -right-40 h-[600px] w-[600px] rounded-full bg-brand-100/40 blur-3xl" />
      <div className="pointer-events-none absolute -bottom-20 -left-40 h-[400px] w-[400px] rounded-full bg-blue-100/30 blur-3xl" />
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <div className="flex flex-col gap-6 max-w-2xl">
            ...
            <motion.div {...fadeUp(0)}>
              <span className="inline-flex items-center gap-2 rounded-full border border-brand-100 bg-brand-50 px-4 py-1.5 text-xs font-semibold uppercase tracking-widest text-brand-600">
                ...
                Plataforma de Inteligencia de Riesgo con IA
              </span>
            </motion.div>
            ...
            <motion.h1
              {...fadeUp(0.1)}
              className="text-5xl font-bold leading-[1.08] tracking-tight text-slate-900 lg:text-6xl"
            >
              Inteligencia impulsada por IA para{" "}
              <span className="gradient-text">ciudades más seguras</span>
            </motion.h1>

            {/* Subheadline */}
            <motion.p
              {...fadeUp(0.2)}
              className="text-lg leading-relaxed text-slate-500 max-w-lg"
            >
              Layers Intel transforma señales territoriales, sociales y digitales
              en inteligencia de riesgo accionable para gobiernos, empresas y
              equipos de seguridad pública.
            </motion.p>
            ...
            >
              {[
                { value: "140+", label: "Zonas Protegidas" },
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -top-4 -right-4 rounded-xl bg-white px-3 py-2 shadow-card border border-slate-100 hidden lg:flex items-center gap-2"
            >
            ...
            <motion.div
              ...
              className="absolute -bottom-4 -left-4 rounded-xl bg-white px-3 py-2 shadow-card border border-slate-100 hidden lg:flex items-center gap-2"
            >
