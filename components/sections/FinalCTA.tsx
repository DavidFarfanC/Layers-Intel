    ...
    <section id="cta" className="section-padding bg-white">
      <div className="mx-auto max-w-4xl px-6 lg:px-8">
        <motion.div
          ...
          className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-brand-600 via-brand-700 to-brand-900 px-8 py-16 text-center shadow-2xl"
        >
          {/* Decorative blobs */}
          ...
          <div className="relative">
            ...
            <p className="text-lg text-brand-200/80 max-w-lg mx-auto mb-10 leading-relaxed">
              Únete a los equipos de seguridad pública y operaciones corporativas
              que ya usan Layers Intel para anticiparse al riesgo.
            </p>
