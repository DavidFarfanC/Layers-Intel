...
export default function Topbar({ title, subtitle, onLogout, alertCount = 3 }: TopbarProps) {
      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-xs font-medium text-slate-700 hover:bg-white hover:border-slate-300 transition-all"
          >
